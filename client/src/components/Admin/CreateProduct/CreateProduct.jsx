...
function CreateProduct() {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const {data} = await axios.post('http://localhost:5000/api/product/create-product', productData)
      if(data?.success){
        ...
        <Box sx={{ minWidth: 120 }}>
          <FormControl fullWidth>
            ...
            >
              ...
              <MenuItem key={1} value={"Medium"}>Medium</MenuItem>
              <MenuItem key={2} value={"Large"}>Large</MenuItem>
            </Select>
          </FormControl>
        </Box>
